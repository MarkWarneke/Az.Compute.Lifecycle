...
$FunctionHelpTestExceptions = Get-Content -Encoding "utf8" -Path "$PSScriptRoot\resources\Test.Exceptions.txt"

Describe "PSScriptAnalyzer" -Tag Build, ScriptAnalyzer {
    ...
    It "Script [<scriptName>] rule [<ruleName>]" -TestCases $testcases {
